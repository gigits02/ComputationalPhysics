...
int main()
{
  ...
  // nonche' a secondo membro, dipende dalle condizioni al bordo
    ...
    int bct;
    cout << "premi 1 se hai condizioni di Dirichlet, 2 se hai condizioni di Robin (Y' nota in a e Y nota in b), 3 Robin invertite (nota Y' in b e Y in a), 4 condizioni di Neumann:" << endl;
    cin >> bct;
    switch ( bct )
    {
        case 1:               
    ...
    for ( int j = 1; j < dim - 1; j++ )
    {
        ...
        D[1][j] = - 2.0 / dx2 + g( x[j_init+j] );      // mu_j
